...
for resized in pyramid_gaussian(img, downscale=1.5): # loop over each layer of the image that you take!
    ...
    for (x,y,window) in sliding_window(resized, stepSize=3, windowSize=(winW,winH)):
...
if k == 27:             #wait for ESC key to exit
    ...
    cv2.imwrite('Datasets\Tested_image\after_test.png',img)
    cv2.destroyAllWindows()
