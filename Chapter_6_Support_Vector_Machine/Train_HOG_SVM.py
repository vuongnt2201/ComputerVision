...
pos_im_path = r"Datasets/ped_examples" # This is the path of our positive input dataset
# define the same for negatives
neg_im_path= r"Datasets/non-ped_examples"
...
# Save the model:
#%% Save the Model
joblib.dump(model, 'trained_model.npy')
